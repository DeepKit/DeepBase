{ ============================================================================
  UniBase.VCL.LicenseAuthDialog - 许可证激活对话框
  
  版本: 1.0
  功能: 提供许可证输入、激活和验证界面
  ============================================================================ }

unit UniBase.VCL.LicenseAuthDialog;
...
type
  ...
  public
    ...
    class function Execute(ALicense: TUniBaseLicense = nil): Boolean;
...
procedure TLicenseAuthDialog.SetLicense(Value: TUniBaseLicense);
begin
...
class function TLicenseAuthDialog.Execute(ALicense: TUniBaseLicense): Boolean;
var
