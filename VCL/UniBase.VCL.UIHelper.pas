{ ============================================================================
  UniBase.VCL.UIHelper - VCL UI 辅助工具
  
  版本: 0.3
  说明: 提供 Windows 11 Mica/Acrylic 等现代 UI 效果的支持
  ============================================================================ }

unit UniBase.VCL.UIHelper;
...
class function TUniBaseUIHelper.ApplyMicaEffect(AForm: TForm; IsDark: Boolean): Boolean;
var
...
class procedure TUniBaseUIHelper.SetTitleBarMode(AForm: TForm; IsDark: Boolean);
var
  DarkMode: Integer;
begin
