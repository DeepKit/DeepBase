{ ============================================================================
  UniBase.VCL.ConfigControls - 配置绑定控件
  
  版本: 1.0
  说明: 自动绑定 UniBase.Config 的 VCL 控件
  ============================================================================ }

unit UniBase.VCL.ConfigControls;
...
begin
  ...
  UniBase.Manager.UniBase.Config.SetConfig(FConfigKey, Text, FCategory);
end;
...
begin
  ...
  Checked := UniBase.Manager.UniBase.Config.GetConfigBool(FConfigKey, FDefaultValue);
end;
...
begin
  ...
  UniBase.Manager.UniBase.Config.SetConfigBool(FConfigKey, Checked, FCategory);
end;
...
begin
  ...
  Value := UniBase.Manager.UniBase.Config.GetConfigInt(FConfigKey, FDefaultValue);
end;
...
begin
  ...
  UniBase.Manager.UniBase.Config.SetConfigInt(FConfigKey, Value, FCategory);
end;
