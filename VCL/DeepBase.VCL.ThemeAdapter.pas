{ ============================================================================
  DeepBase.VCL.ThemeAdapter - VCL adapter for DeepBase.Theme
  ============================================================================ }

unit DeepBase.VCL.ThemeAdapter;

interface

procedure RegisterDeepBaseVCLThemeAdapter;
...
procedure RegisterDeepBaseVCLThemeAdapter;
begin
  TDeepBaseTheme.SetPlatformAdapter(
    ApplyVclTheme,
    ListVclThemes,
    VclStyleExists,
    CurrentVclTheme);
...
initialization
  RegisterDeepBaseVCLThemeAdapter;
