...
function TImageExport.GetWidth: Integer;
begin
  Result := FBitmap.Width;
end;

function TImageExport.GetHeight: Integer;
begin
...
begin
  ...
  begin
    ...
    FBitmap.Canvas.Pen.Width := FLineWidth;
    FBitmap.Canvas.Brush.Style := bsClear;
    FBitmap.Canvas.RoundRect(R.Left, R.Top, R.Right, R.Bottom, ARadius, ARadius);
  end;
end;
...
begin
  ...
  begin
    if Odd(I) then
      C.Brush.Color := TColor(RGB(245, 245, 245))
    else
