...
constructor TGuard.Create(const AConfig: TDeepFlowConfig);
var
  Meta: TRoleMetaInfo;
begin
  Meta.Name := 'Guard';
...
function TGuard.DoHandleMessage(const AMessage: TDeepFlowMessage): TDeepFlowMessage;
var
