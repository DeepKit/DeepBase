...
class Config:
    """Skill Service 配置"""
    HOST = os.getenv("DeepFlow_SKILL_HOST", "127.0.0.1")
    PORT = int(os.getenv("DeepFlow_SKILL_PORT", "8000"))
    MOCK_LLM_URL = os.getenv("DeepFlow_MOCK_LLM_URL", "http://127.0.0.1:8766")
    USE_MOCK_AI = os.getenv("DeepFlow_USE_MOCK_AI", "true").lower() == "true"
    DEBUG = os.getenv("DeepFlow_DEBUG", "true").lower() == "true"
...
app = FastAPI(
    title="DeepFlow Skill Service",
    description="DeepFlow 技能执行服务",
    version="1.0.0"
)
