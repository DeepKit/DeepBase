...
class MockLLMService:
    ...
    def _init_preset_responses(self):
        ...
        presets = {
            # 基础问答
            "你好": "你好！我是 DeepFlow 的 AI 助手，有什么可以帮助你的？",
            "hello": "Hello! I'm DeepFlow's AI assistant. How can I help you?",
...
def create_app(config: MockConfig = None) -> FastAPI:
    ...
    app = FastAPI(
        title="DeepFlow Mock LLM Service",
...
def main():
    parser = argparse.ArgumentParser(description="DeepFlow Mock LLM Service")
