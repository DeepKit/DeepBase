{ ============================================================================
  UniBase.Microservice.Client - REST API Client with Resilience Patterns
...
unit UniBase.Microservice.Client;
...
begin
  ...
  FHttpClient.UserAgent := 'UniBase-MicroserviceClient/1.0';
