{ ============================================================================
  Test.UniBase.FMX - FMX Controls Unit Tests
  
  Version: 1.0
  Description: Unit tests for UniBase FMX cross-platform controls
...
type
  ...
  public
    ...
    [Test]
    procedure Test_UniChipInput_AddRemoveChip;
...
begin
  ...
  try
    ...
    // Without UniBase initialized, should keep original text
...
procedure TTestFMXFormControls.Test_UniChipInput_AddRemoveChip;
var
  ChipInput: TUniChipInput;
begin
  ChipInput := TUniChipInput.Create(FForm);
