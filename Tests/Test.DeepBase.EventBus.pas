unit Test.DeepBase.EventBus;

{*******************************************************************************
  DeepBase EventBus Module Unit Tests
...
{ TTestDeepBaseEventBus }

procedure TTestDeepBaseEventBus.Setup;
begin
  FEventBus := TEventBus.Create;
end;

procedure TTestDeepBaseEventBus.TearDown;
begin
  FEventBus.Free;
  FEventBus := nil;
end;

procedure TTestDeepBaseEventBus.Test_Subscribe_And_Publish_BasicEvent;
var
...
procedure TTestDeepBaseEventBus.Test_Subscribe_MultipleHandlers;
var
  Count: Integer;
begin
  Count := 0;
...
procedure TTestDeepBaseEventBus.Test_Unsubscribe_RemovesHandler;
var
  Count: Integer;
...
procedure TTestDeepBaseEventBus.Test_UnsubscribeAll_RemovesAllHandlersForType;
var
...
procedure TTestDeepBaseEventBus.Test_UnsubscribeByTag_RemovesTaggedHandlers;
var
...
procedure TTestDeepBaseEventBus.Test_SubscribeWeak_AutoUnsubscribe_OnOwnerDestroy;
var
  Owner: TComponent;
...
procedure TTestDeepBaseEventBus.Test_SubscribeWeak_ManualUnsubscribe_DetachesOwnerLink;
var
  Owner: TComponent;
  DeliveryCount: Integer;
  Subscription: ISubscription;
...
procedure TTestDeepBaseEventBus.Test_Priority_HighBeforeNormal;
var
  Order: string;
begin
  Order := '';
...
procedure TTestDeepBaseEventBus.Test_Priority_CriticalFirst;
var
  Order: string;
begin
  Order := '';
...
procedure TTestDeepBaseEventBus.Test_Priority_OrderPreservedWithinSamePriority;
var
  Order: string;
begin
  Order := '';
...
procedure TTestDeepBaseEventBus.Test_Filter_OnlyMatchingEventsDelivered;
var
...
procedure TTestDeepBaseEventBus.Test_Filter_NoFilterReceivesAll;
var
  ReceivedCount: Integer;
begin
  ReceivedCount := 0;
...
procedure TTestDeepBaseEventBus.Test_DispatchMode_Sync_ExecutesImmediately;
var
  Executed: Boolean;
begin
  Executed := False;
...
procedure TTestDeepBaseEventBus.Test_Stats_TotalDelivered;
var
  InitialCount: Int64;
begin
...
procedure TTestDeepBaseEventBus.Test_Stats_TotalFiltered;
var
  InitialCount: Int64;
begin
...
procedure TTestDeepBaseEventBus.Test_Stats_ActiveSubscriptions;
var
...
procedure TTestDeepBaseEventBus.Test_Stats_Reset;
begin
  FEventBus.Subscribe<TTestEvent>(
    procedure(const Event: TTestEvent)
    begin
...
procedure TTestDeepBaseEventBus.Test_HasSubscribers_True;
begin
  FEventBus.Subscribe<TTestEvent>(
    procedure(const Event: TTestEvent)
    begin
...
procedure TTestDeepBaseEventBus.Test_HasSubscribers_False;
begin
  Assert.IsFalse(FEventBus.HasSubscribers<TTestEvent>);
end;

procedure TTestDeepBaseEventBus.Test_GetSubscriberCount;
begin
  Assert.AreEqual(0, FEventBus.GetSubscriberCount<TTestEvent>);
...
procedure TTestDeepBaseEventBus.Test_GetEventTypes;
var
  Types: TArray<string>;
begin
  FEventBus.Subscribe<TTestEvent>(
...
procedure TTestDeepBaseEventBus.Test_KeepHistory_StoresEvents;
begin
...
procedure TTestDeepBaseEventBus.Test_ReplayHistory_DeliversPastEvents;
var
  Count: Integer;
begin
  Count := 0;
...
procedure TTestDeepBaseEventBus.Test_ClearHistory;
var
  Count: Integer;
begin
  Count := 0;
...
procedure TTestDeepBaseEventBus.Test_MaxHistorySize_LimitsStorage;
var
  Count: Integer;
begin
  Count := 0;
...
procedure TTestDeepBaseEventBus.Test_Disabled_NoEventsDelivered;
var
  Received: Boolean;
begin
  Received := False;
...
procedure TTestDeepBaseEventBus.Test_ReEnabled_EventsDelivered;
var
  Received: Boolean;
begin
  Received := False;
...
procedure TTestDeepBaseEventBus.Test_OnError_CalledOnException;
var
  ErrorCalled: Boolean;
  ErrorMessage: string;
begin
...
procedure TTestDeepBaseEventBus.Test_DeadLetter_CalledWhenNoSubscribers;
var
...
procedure TTestDeepBaseEventBus.Test_Clear_RemovesAllSubscriptions;
begin
  FEventBus.Subscribe<TTestEvent>(
    procedure(const Event: TTestEvent)
    begin
...
procedure TTestDeepBaseEventBus.Test_ThreadSafety_ConcurrentPublish;
var
  Tasks: TArray<ITask>;
  ReceivedCount: Integer;
...
procedure TTestDeepBaseEventBus.Test_ThreadSafety_ConcurrentSubscribeUnsubscribe;
var
  Tasks: TArray<ITask>;
  ErrorCount: Integer;
  Lock: TCriticalSection;
...
procedure TTestDeepBaseEventBus.Test_Subscription_IsActive;
var
  Sub: ISubscription;
begin
  Sub := FEventBus.Subscribe<TTestEvent>(
...
procedure TTestDeepBaseEventBus.Test_Subscription_GetEventType;
var
  Sub: ISubscription;
begin
  Sub := FEventBus.Subscribe<TTestEvent>(
