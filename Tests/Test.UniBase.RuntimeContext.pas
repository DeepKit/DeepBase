unit Test.UniBase.RuntimeContext;
...
type
  ...
  TTestRuntimeComponent = class(TUniBaseRuntimeComponent)
  private
    FLog: TStrings;
  ...
  /// </summary>
  TEventBusRuntimeComponent = class(TUniBaseRuntimeComponent)
  private
  ...
  /// </summary>
  TWorkerQueueRuntimeComponent = class(TUniBaseRuntimeComponent)
  private
  ...
  /// </summary>
  TSchedulerRuntimeComponent = class(TUniBaseRuntimeComponent)
  private
  ...
  /// </summary>
  TIoCRuntimeComponent = class(TUniBaseRuntimeComponent)
  private
    FStarted: Boolean;
  public
    procedure Start; override;
  ...
  [TestFixture]
  TTestUniBaseRuntimeContext = class
  private
    FContext: TUniBaseRuntimeContext;
    FLog: TStringList;
...
begin
  // Allow async callbacks to drain by sleeping briefly
  Sleep(50);
end;
...
{ TTestUniBaseRuntimeContext }

procedure TTestUniBaseRuntimeContext.Setup;
begin
  FContext := TUniBaseRuntimeContext.Create;
  FLog := TStringList.Create;
end;

procedure TTestUniBaseRuntimeContext.TearDown;
begin
  FContext.Free;
  FLog.Free;
end;

procedure TTestUniBaseRuntimeContext.AssertLogEquals(
...
procedure TTestUniBaseRuntimeContext.StartAndShutdown_RunInDeterministicOrder;
begin
...
procedure TTestUniBaseRuntimeContext.InitializeFailure_ShutsDownConfiguredComponentsInReverse;
begin
  FContext.RegisterComponent(TTestRuntimeComponent.Create('A', FLog));
  FContext.RegisterComponent(TTestRuntimeComponent.Create('B', FLog,
    faInitialize));
...
procedure TTestUniBaseRuntimeContext.StartFailure_StopsStartedAndShutsDownConfiguredComponents;
begin
  FContext.RegisterComponent(TTestRuntimeComponent.Create('A', FLog));
...
procedure TTestUniBaseRuntimeContext.RegisterAfterConfigure_Raises;
var
...
procedure TTestUniBaseRuntimeContext.EventBusComponent_StartsStopsAndClears;
var
  Bus: TEventBus;
  Token: ISubscription;
begin
...
procedure TTestUniBaseRuntimeContext.WorkerQueueComponent_StartsAndStopsQueue;
var
  Queue: TWorkerQueue;
  Stats: TQueueStats;
begin
...
procedure TTestUniBaseRuntimeContext.WorkerQueueComponent_Stop_DrainsRunningJobs;
var
  Queue: TWorkerQueue;
  StartedEvent: TEvent;
...
procedure TTestUniBaseRuntimeContext.WorkerQueueComponent_CancelByTag_ThenStop_JoinsRunningJob;
var
  Queue: TWorkerQueue;
  StartedEvent: TEvent;
  AllowFinishEvent: TEvent;
...
procedure TTestUniBaseRuntimeContext.SchedulerComponent_StartsAndStopsScheduler;
var
...
procedure TTestUniBaseRuntimeContext.SchedulerComponent_Stop_WaitsForRunningTasks;
var
  Scheduler: TTaskScheduler;
  StartedEvent: TEvent;
  AllowFinishEvent: TEvent;
...
procedure TTestUniBaseRuntimeContext.ShutdownWithoutStart_DoesNotStopGlobalEventBus;
var
  Bus: TEventBus;
begin
  Bus := EventBus;
...
procedure TTestUniBaseRuntimeContext.ShutdownWithoutStart_DoesNotStopExplicitEventBus;
var
  Bus: TEventBus;
...
procedure TTestUniBaseRuntimeContext.ShutdownWithoutStart_DoesNotStopGlobalWorkerQueue;
var
  Queue: TWorkerQueue;
begin
  Queue := WorkerQueue();
...
procedure TTestUniBaseRuntimeContext.ShutdownWithoutStart_DoesNotStopExplicitWorkerQueue;
var
  Queue: TWorkerQueue;
begin
...
procedure TTestUniBaseRuntimeContext.ShutdownWithoutStart_DoesNotClearGlobalIoCContainer;
var
...
procedure TTestUniBaseRuntimeContext.ShutdownWithoutStart_DoesNotStopExplicitScheduler;
var
  Scheduler: TTaskScheduler;
begin
  Scheduler := TTaskScheduler.Create;
...
procedure TTestUniBaseRuntimeContext.EventBusComponent_Stop_DrainsAsyncCallbacks;
var
  Bus: TEventBus;
...
procedure TTestUniBaseRuntimeContext.CustomLifecycleOrder_StopsAsyncBeforeManager_AndLoggerBeforePersistence;
begin
...
initialization
  TDUnitX.RegisterTestFixture(TTestUniBaseRuntimeContext);
