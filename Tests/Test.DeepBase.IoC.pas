{ ============================================================================
  Test.DeepBase.IoC - IoC Container Unit Tests
  ============================================================================ }

unit Test.DeepBase.IoC;
...
type
  ...
  public
    ...
    [Test]
    procedure Test_InterfaceFactory_CanSatisfyConstructorDependency;
...
procedure TIoCContainerTests.Test_InterfaceFactory_CanSatisfyConstructorDependency;
var
  Service: ITestServiceWithDep;
begin
  FContainer.RegisterFactory<ITestService>(
    function: ITestService
    begin
    ...
    slSingleton);
  FContainer.RegisterTransient<ITestServiceWithDep, TTestServiceWithDep>;

  Service := FContainer.Resolve<ITestServiceWithDep>;

  Assert.AreEqual('Combined:ServiceA', Service.GetCombinedValue);
end;
