{ ============================================================================
  Test.UniBase.Services.HealthCheck - Unit Tests for Health Check Service

  Tests only the APIs that actually exist in Core/UniBase.Services.HealthCheck.pas:
...
unit Test.UniBase.Services.HealthCheck;
