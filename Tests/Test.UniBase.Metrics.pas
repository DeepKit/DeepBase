unit Test.UniBase.Metrics;

{*******************************************************************************
  Unit Tests for UniBase.Metrics
...
procedure TTestUniBaseMetrics.Setup;
begin
end;

procedure TTestUniBaseMetrics.TearDown;
begin
end;

// TCounter Tests

procedure TTestUniBaseMetrics.TestCounterCreate;
var
  Counter: TCounter;
begin
...
procedure TTestUniBaseMetrics.TestCounterInc;
var
  Counter: TCounter;
begin
  Counter := TCounter.Create('test_counter', 'Test counter', []);
...
procedure TTestUniBaseMetrics.TestCounterIncAmount;
var
  Counter: TCounter;
begin
  Counter := TCounter.Create('test_counter', 'Test counter', []);
...
procedure TTestUniBaseMetrics.TestCounterReset;
var
  Counter: TCounter;
begin
  Counter := TCounter.Create('test_counter', 'Test counter', []);
...
procedure TTestUniBaseMetrics.TestCounterToJSON;
var
  Counter: TCounter;
  JSON: TJSONObject;
begin
...
procedure TTestUniBaseMetrics.TestCounterToPrometheus;
var
  Counter: TCounter;
  S: string;
begin
...
procedure TTestUniBaseMetrics.TestGaugeCreate;
var
  Gauge: TGauge;
begin
...
procedure TTestUniBaseMetrics.TestGaugeSetValue;
var
  Gauge: TGauge;
begin
  Gauge := TGauge.Create('test_gauge', 'Test gauge', []);
...
procedure TTestUniBaseMetrics.TestGaugeIncDec;
var
  Gauge: TGauge;
begin
  Gauge := TGauge.Create('test_gauge', 'Test gauge', []);
...
procedure TTestUniBaseMetrics.TestGaugeToJSON;
var
  Gauge: TGauge;
  JSON: TJSONObject;
begin
...
procedure TTestUniBaseMetrics.TestGaugeToPrometheus;
var
  Gauge: TGauge;
  S: string;
begin
...
procedure TTestUniBaseMetrics.TestHistogramCreate;
var
...
procedure TTestUniBaseMetrics.TestHistogramObserve;
var
  Histogram: THistogram;
begin
  Histogram := THistogram.Create('test_histogram', 'Test histogram', [],
...
procedure TTestUniBaseMetrics.TestHistogramStats;
var
  Histogram: THistogram;
begin
  Histogram := THistogram.Create('test_histogram', 'Test histogram', [],
...
procedure TTestUniBaseMetrics.TestHistogramBuckets;
var
  Histogram: THistogram;
...
procedure TTestUniBaseMetrics.TestHistogramDefaultBuckets;
var
...
procedure TTestUniBaseMetrics.TestHistogramLinearBuckets;
var
  Buckets: TArray<Double>;
begin
...
procedure TTestUniBaseMetrics.TestHistogramExponentialBuckets;
var
  Buckets: TArray<Double>;
begin
...
procedure TTestUniBaseMetrics.TestHistogramToPrometheus;
var
  Histogram: THistogram;
  S: string;
begin
...
procedure TTestUniBaseMetrics.TestTimerCreate;
var
  Timer: TTimer;
begin
...
procedure TTestUniBaseMetrics.TestTimerRecordDuration;
var
  Timer: TTimer;
begin
...
procedure TTestUniBaseMetrics.TestTimerTime;
var
  Timer: TTimer;
begin
...
procedure TTestUniBaseMetrics.TestTimerStart;
var
  Timer: TTimer;
  StopTimer: TProc;
begin
...
procedure TTestUniBaseMetrics.TestSummaryCreate;
var
  Summary: TSummary;
begin
...
procedure TTestUniBaseMetrics.TestSummaryObserve;
var
  Summary: TSummary;
begin
  Summary := TSummary.Create('test_summary', 'Test summary', [], [0.5, 0.9, 0.99]);
...
procedure TTestUniBaseMetrics.TestMetricFamilyCreate;
var
...
procedure TTestUniBaseMetrics.TestMetricFamilyWithLabels;
var
  Family: TMetricFamily<TCounter>;
  Counter: TCounter;
begin
...
procedure TTestUniBaseMetrics.TestRegistryCreate;
var
...
procedure TTestUniBaseMetrics.TestRegistryCounter;
var
  Registry: TMetricsRegistry;
  Counter: TCounter;
begin
...
procedure TTestUniBaseMetrics.TestRegistryGauge;
var
  Registry: TMetricsRegistry;
  Gauge: TGauge;
begin
...
procedure TTestUniBaseMetrics.TestRegistryHistogram;
var
  Registry: TMetricsRegistry;
  Histogram: THistogram;
begin
...
procedure TTestUniBaseMetrics.TestRegistryGetAll;
var
  Registry: TMetricsRegistry;
...
procedure TTestUniBaseMetrics.TestRegistryToPrometheus;
var
  Registry: TMetricsRegistry;
  S: string;
begin
...
procedure TTestUniBaseMetrics.TestRegistryToInfluxLines;
var
  Registry: TMetricsRegistry;
  S: string;
begin
...
procedure TTestUniBaseMetrics.TestCounterThreadSafety;
var
  Counter: TCounter;
...
procedure TTestUniBaseMetrics.TestGaugeThreadSafety;
var
  Gauge: TGauge;
  Threads: array[0..9] of TThread;
  I: Integer;
...
procedure TTestUniBaseMetrics.TestMetricsStaticCounter;
begin
  TMetrics.Counter('static_counter').Inc;
  Assert.IsTrue(TMetrics.Counter('static_counter').Value >= 1);
end;

procedure TTestUniBaseMetrics.TestMetricsStaticGauge;
begin
