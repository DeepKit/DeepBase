unit Test.UniBase.Net;

{*******************************************************************************
  Unit Tests for UniBase.Net
...
procedure TTestUniBaseNet.Setup;
begin
end;

procedure TTestUniBaseNet.TearDown;
begin
end;

// THttpResponse Tests

procedure TTestUniBaseNet.TestHttpResponseIsSuccess;
var
...
procedure TTestUniBaseNet.TestHttpResponseIsRedirect;
var
  Response: THttpResponse;
begin
...
procedure TTestUniBaseNet.TestHttpResponseIsClientError;
var
  Response: THttpResponse;
begin
  Response.StatusCode := 400;
...
procedure TTestUniBaseNet.TestHttpResponseIsServerError;
var
  Response: THttpResponse;
begin
...
procedure TTestUniBaseNet.TestHttpRequestCreate;
var
...
procedure TTestUniBaseNet.TestHttpRequestHeaders;
var
  Request: THttpRequest;
begin
...
procedure TTestUniBaseNet.TestHttpRequestQueryParams;
var
  Request: THttpRequest;
begin
  Request := THttpRequest.Create('https://example.com');
...
procedure TTestUniBaseNet.TestHttpRequestBasicAuth;
var
  Request: THttpRequest;
begin
  Request := THttpRequest.Create('https://example.com');
...
procedure TTestUniBaseNet.TestHttpRequestBearerToken;
var
  Request: THttpRequest;
begin
  Request := THttpRequest.Create('https://example.com');
...
procedure TTestUniBaseNet.TestHttpClientCreate;
var
  Client: THttpClient_;
begin
...
procedure TTestUniBaseNet.TestHttpClientDefaultHeaders;
var
  Client: THttpClient_;
begin
...
procedure TTestUniBaseNet.TestHttpClientRequest;
var
  Client: THttpClient_;
  Request: THttpRequest;
begin
...
procedure TTestUniBaseNet.TestWebSocketCreate;
var
  WS: TWebSocketClient;
begin
...
procedure TTestUniBaseNet.TestWebSocketState;
var
  WS: TWebSocketClient;
begin
  WS := TWebSocketClient.Create('ws://localhost:8080');
...
procedure TTestUniBaseNet.TestDnsRecordToString;
var
  Rec: TDnsRecord;
begin
  Rec.RecordType := drtA;
...
procedure TTestUniBaseNet.TestDnsResolverCreate;
var
...
procedure TTestUniBaseNet.TestIPv4Parse;
var
  IP: TIPv4Address;
begin
...
procedure TTestUniBaseNet.TestIPv4ToString;
var
  IP: TIPv4Address;
begin
...
procedure TTestUniBaseNet.TestIPv4ToInteger;
var
  IP: TIPv4Address;
begin
...
procedure TTestUniBaseNet.TestIPv4IsPrivate;
var
  IP: TIPv4Address;
begin
  IP := TIPv4Address.Parse('192.168.1.1');
...
procedure TTestUniBaseNet.TestIPv4IsLoopback;
var
  IP: TIPv4Address;
begin
...
procedure TTestUniBaseNet.TestIPv4IsMulticast;
var
  IP: TIPv4Address;
begin
...
procedure TTestUniBaseNet.TestIPv4Operators;
var
...
procedure TTestUniBaseNet.TestIPv4SubnetParse;
var
  Subnet: TIPv4Subnet;
begin
...
procedure TTestUniBaseNet.TestIPv4SubnetContains;
var
  Subnet: TIPv4Subnet;
  IP: TIPv4Address;
begin
...
procedure TTestUniBaseNet.TestIPv4SubnetBroadcast;
var
  Subnet: TIPv4Subnet;
begin
  Subnet := TIPv4Subnet.Parse('192.168.1.0/24');
...
procedure TTestUniBaseNet.TestIPv4SubnetHostCount;
var
  Subnet: TIPv4Subnet;
begin
  Subnet := TIPv4Subnet.Parse('192.168.1.0/24');
...
procedure TTestUniBaseNet.TestUrlEncode;
begin
...
procedure TTestUniBaseNet.TestUrlDecode;
begin
...
procedure TTestUniBaseNet.TestBuildUrl;
var
...
procedure TTestUniBaseNet.TestParseUrl;
var
...
procedure TTestUniBaseNet.TestJoinUrl;
begin
...
procedure TTestUniBaseNet.TestIsValidIPv4;
begin
...
procedure TTestUniBaseNet.TestIsValidHostname;
begin
...
procedure TTestUniBaseNet.TestIsValidPort;
begin
...
procedure TTestUniBaseNet.TestGetServicePort;
begin
...
procedure TTestUniBaseNet.TestIPv4ToInteger2;
begin
...
procedure TTestUniBaseNet.TestIsPrivateIP;
begin
...
procedure TTestUniBaseNet.TestIsLoopbackIP;
begin
...
procedure TTestUniBaseNet.TestCompareIPv4;
begin
