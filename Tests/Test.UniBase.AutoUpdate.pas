{ ============================================================================
  Test.UniBase.AutoUpdate - Unit Tests for Auto-Update Module
...
begin
  AutoUpdate := TUniBaseAutoUpdate.Create('https://example.com/version.json', '1.0.0');
  try
...
var
  AutoUpdate: TUniBaseAutoUpdate;
begin
  AutoUpdate := TUniBaseAutoUpdate.Create;
  try
