{ ============================================================================
  Test.DeepBase.SingleInstance - Unit Tests for Single Instance Application Module
...
unit Test.DeepBase.SingleInstance;
...
type
  ...
  public
    [Test]
    procedure Test_WM_DeepBase_COPYDATA;
    [Test]
    procedure Test_WM_DeepBase_ACTIVATE;
    [Test]
...
begin
  // TCommandLineReceivedEvent is "of object" â€?cannot assign anonymous procedure.
...
begin
  ...
  Identifier := 'Test.DeepBase.' + TGUID.NewGuid.ToString;
...
var
  Id1, Id2: string;
begin
  Id1 := 'Test.DeepBase.ID1.' + TGUID.NewGuid.ToString;
  Id2 := 'Test.DeepBase.ID2.' + TGUID.NewGuid.ToString;
...
procedure TTestMessageConstants.Test_WM_DeepBase_COPYDATA;
begin
  Assert.AreEqual($0400 + $1B01, Integer(WM_DeepBase_COPYDATA));
  Assert.IsTrue(WM_DeepBase_COPYDATA > $0400);
end;

procedure TTestMessageConstants.Test_WM_DeepBase_ACTIVATE;
begin
  Assert.AreEqual($0400 + $1B02, Integer(WM_DeepBase_ACTIVATE));
  Assert.IsTrue(WM_DeepBase_ACTIVATE > $0400);
end;

procedure TTestMessageConstants.Test_Constants_AreUnique;
begin
  Assert.AreNotEqual(WM_DeepBase_COPYDATA, WM_DeepBase_ACTIVATE);
end;
