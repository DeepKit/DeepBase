{ ============================================================================
  Test.DeepBase.ORM - ORM Unit Tests
  ============================================================================ }

unit Test.DeepBase.ORM;
...
uses
  DeepBase.Persistence.ORM.FireDAC;
...
begin
  ...
  try
    ...
    Assert.IsTrue(RaisedMsg.Contains('DeepBase.Persistence.ORM.FireDAC'),
