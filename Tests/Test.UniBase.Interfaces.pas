{ ============================================================================
  Test.UniBase.Interfaces - Unit Tests for Core Interfaces
  
  Test Coverage:
    - IUniBaseConfig mock implementation
    - IUniBaseLogger mock implementation
    - IUniBaseI18n mock implementation
    - IUniBaseMRU mock implementation
    - IUniBaseManager mock implementation
  ============================================================================ }

unit Test.UniBase.Interfaces;
...
type
  ...
  TMockConfig = class(TInterfacedObject, IUniBaseConfig)
  private
  ...
  TMockLogger = class(TInterfacedObject, IUniBaseLogger)
  private
    FMinLevel: TLogLevel;
  ...
  TMockI18n = class(TInterfacedObject, IUniBaseI18n)
  private
    FLang: string;
  public
    constructor Create;
  ...
  TMockMRU = class(TInterfacedObject, IUniBaseMRU)
  private
  ...
  TMockManager = class(TInterfacedObject, IUniBaseManager)
  private
    FConfig: IUniBaseConfig;
    FLogger: IUniBaseLogger;
    FI18n: IUniBaseI18n;
    FMRU: IUniBaseMRU;
    FRootPath: string;
...
function TMockManager.GetConfig: IUniBaseConfig;
begin
  Result := FConfig;
end;

function TMockManager.GetLogger: IUniBaseLogger;
begin
  Result := FLogger;
end;

function TMockManager.GetI18n: IUniBaseI18n;
begin
  Result := FI18n;
end;

function TMockManager.GetMRU: IUniBaseMRU;
begin
  Result := FMRU;
end;
