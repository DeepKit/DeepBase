{ ============================================================================
  Test.DeepBase.PublishConfig - Unit Tests for Publish Configuration
...
unit Test.DeepBase.PublishConfig;
...
begin
  ...
  FTempDir := TPath.Combine(TPath.GetTempPath, 'DeepBaseTests_' + TGUID.NewGuid.ToString);
...
begin
  FTempFile := TPath.Combine(TPath.GetTempPath, 
    'DeepBaseMRUTest_' + TGUID.NewGuid.ToString + '.json');
