{ ============================================================================ 
  Test.DeepBase.Consts - Unit tests for DeepBase.Consts constants
...
procedure TTestDeepBaseConsts.ConfigKeys_AreNotEmpty_AndDistinct;
var
...
procedure TTestDeepBaseConsts.DefaultValues_AreExpected;
begin
...
procedure TTestDeepBaseConsts.MRUCategories_AreExpected;
begin
...
procedure TTestDeepBaseConsts.TableNames_AreNotEmpty_AndDistinct;
var
  Seen: TDictionary<string, Boolean>;
...
procedure TTestDeepBaseConsts.LogLevelStrings_AreUppercaseAndExpected;
begin
...
initialization
  TDUnitX.RegisterTestFixture(TTestDeepBaseConsts);
