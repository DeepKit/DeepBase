unit Test.UniBase.i18n.Gender;

{*******************************************************************************
  Unit Tests for UniBase.i18n.Gender
...
procedure TTestUniBaseI18nGender.Setup;
begin
end;

procedure TTestUniBaseI18nGender.TearDown;
begin
end;

// TGenderVariant Tests

procedure TTestUniBaseI18nGender.TestGenderVariantHasGender;
begin
...
procedure TTestUniBaseI18nGender.TestGenderVariantHasCases;
begin
...
procedure TTestUniBaseI18nGender.TestGenderVariantGetDirection;
begin
...
procedure TTestUniBaseI18nGender.TestGenderVariantIsRTL;
begin
...
procedure TTestUniBaseI18nGender.TestGenderVariantSelectMasculine;
begin
  Assert.AreEqual('der Mann', TGenderVariant.Select('de', ggMasculine, 
    ['der Mann', 'die Frau', 'das Kind']));
end;

procedure TTestUniBaseI18nGender.TestGenderVariantSelectFeminine;
begin
  Assert.AreEqual('die Frau', TGenderVariant.Select('de', ggFeminine, 
    ['der Mann', 'die Frau', 'das Kind']));
end;

procedure TTestUniBaseI18nGender.TestGenderVariantSelectNeuter;
begin
  Assert.AreEqual('das Kind', TGenderVariant.Select('de', ggNeuter, 
    ['der Mann', 'die Frau', 'das Kind']));
end;

procedure TTestUniBaseI18nGender.TestGenderVariantTransformFrench;
begin
...
procedure TTestUniBaseI18nGender.TestGenderVariantTransformSpanish;
begin
...
procedure TTestUniBaseI18nGender.TestGenderVariantFormat;
var
  Result: string;
begin
...
procedure TTestUniBaseI18nGender.TestCaseVariantSelect;
begin
...
procedure TTestUniBaseI18nGender.TestCaseVariantGetCaseName;
begin
...
procedure TTestUniBaseI18nGender.TestRTLIsRTLChar;
begin
...
procedure TTestUniBaseI18nGender.TestRTLContainsRTL;
begin
...
procedure TTestUniBaseI18nGender.TestRTLGetDominantDirection;
begin
...
procedure TTestUniBaseI18nGender.TestRTLEmbedRTL;
var
  Result: string;
begin
...
procedure TTestUniBaseI18nGender.TestRTLEmbedLTR;
var
  Result: string;
begin
...
procedure TTestUniBaseI18nGender.TestRTLReverseString;
begin
...
procedure TTestUniBaseI18nGender.TestCaseUtilsToLower;
begin
  Assert.AreEqual('hello world', TCaseUtils.ToLower('HELLO WORLD'));
  Assert.AreEqual('hello world', TCaseUtils.ToLower('Hello World'));
end;

procedure TTestUniBaseI18nGender.TestCaseUtilsToUpper;
begin
  Assert.AreEqual('HELLO WORLD', TCaseUtils.ToUpper('hello world'));
  Assert.AreEqual('HELLO WORLD', TCaseUtils.ToUpper('Hello World'));
end;

procedure TTestUniBaseI18nGender.TestCaseUtilsToTitleCase;
begin
...
procedure TTestUniBaseI18nGender.TestCaseUtilsToSentenceCase;
begin
  Assert.AreEqual('Hello world. How are you?', 
    TCaseUtils.ToSentenceCase('HELLO WORLD. HOW ARE YOU?'));
end;

procedure TTestUniBaseI18nGender.TestCaseUtilsCapitalize;
begin
...
procedure TTestUniBaseI18nGender.TestCaseUtilsUncapitalize;
begin
...
procedure TTestUniBaseI18nGender.TestCaseUtilsIsLower;
begin
...
procedure TTestUniBaseI18nGender.TestCaseUtilsIsUpper;
begin
...
procedure TTestUniBaseI18nGender.TestCaseUtilsApply;
begin
...
procedure TTestUniBaseI18nGender.TestGermanGenders;
var
...
procedure TTestUniBaseI18nGender.TestRussianCases;
var
  Info: TLanguageGenderInfo;
begin
...
procedure TTestUniBaseI18nGender.TestArabicRTL;
var
  Info: TLanguageGenderInfo;
begin
...
procedure TTestUniBaseI18nGender.TestChineseNoGender;
var
  Info: TLanguageGenderInfo;
begin
...
procedure TTestUniBaseI18nGender.TestGlobalGenderSelect;
begin
...
procedure TTestUniBaseI18nGender.TestGlobalCaseSelect;
begin
...
procedure TTestUniBaseI18nGender.TestGlobalIsRTLLanguage;
begin
...
procedure TTestUniBaseI18nGender.TestGlobalGetGenderName;
begin
...
procedure TTestUniBaseI18nGender.TestGlobalGetCaseName;
begin
