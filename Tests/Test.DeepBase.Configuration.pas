...
type
  TConfigurationBuilderAutoFreeHelper = class helper for TConfigurationBuilder
    function BuildAuto: TConfiguration;
  end;

function TConfigurationBuilderAutoFreeHelper.BuildAuto: TConfiguration;
begin
  try
    Result := Self.Build;
  finally
...
var
  Config: TConfiguration;
begin
  Config := TConfigurationBuilder.Create.AddMemory([]).BuildAuto;
  TConfig.SetDefault(Config);
