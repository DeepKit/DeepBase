{ ============================================================================
  Test.DeepBase.PluginManager - Unit Tests for Plugin Manager Module
...
unit Test.DeepBase.PluginManager;
...
type
  ...
  private
    ...
    function CreateMockContext: IDeepBasePluginContext;
  public
    [Setup]
    procedure Setup;
    [TearDown]
...
type
  TMockPluginContext = class(TInterfacedObject, IDeepBasePluginContext)
  private
    FRootPath: string;
