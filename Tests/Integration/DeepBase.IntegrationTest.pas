{ ============================================================================
  DeepBase.IntegrationTest - 集成测试框架核心模块
...
begin
  ...
  Result.TempPath := TPath.Combine(TPath.GetTempPath, 'DeepBaseTests');
...
begin
  ...
  try
    SB.AppendLine('================================================================================');
    SB.AppendLine('                        DeepBase INTEGRATION TEST REPORT');
    SB.AppendLine('================================================================================');
    SB.AppendLine;
...
begin
  ...
  try
    ...
    SB.AppendLine('  <title>DeepBase Integration Test Report</title>');
    SB.AppendLine('  <style>');
    ...
    SB.AppendLine('  <h1>DeepBase Integration Test Report</h1>');
...
begin
  ...
  try
    SB.AppendLine('<?xml version="1.0" encoding="UTF-8"?>');
    SB.AppendFormat('<testsuite name="DeepBase.IntegrationTests" tests="%d" failures="%d" errors="%d" skipped="%d" time="%.3f">',
