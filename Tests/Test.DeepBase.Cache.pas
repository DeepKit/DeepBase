...
procedure TTestDeepBaseCache.Setup;
begin
  FCache := TCache<string, string>.Create;
end;

procedure TTestDeepBaseCache.TearDown;
begin
  FCache.Free;
  FCache := nil;
end;

procedure TTestDeepBaseCache.Test_Put_And_Get_String;
begin
  FCache.Put('key1', 'value1');
  Assert.AreEqual('value1', FCache.Get('key1'));
end;

procedure TTestDeepBaseCache.Test_Put_And_Get_Integer_Keys;
var
...
procedure TTestDeepBaseCache.Test_Get_NonExistent_ReturnsDefault;
begin
  Assert.AreEqual('default', FCache.Get('nonexistent', 'default'));
end;

procedure TTestDeepBaseCache.Test_TryGet_ExistingKey_ReturnsTrue;
var
  Value: string;
begin
  FCache.Put('key1', 'value1');
...
procedure TTestDeepBaseCache.Test_TryGet_NonExistent_ReturnsFalse;
var
  Value: string;
begin
...
procedure TTestDeepBaseCache.Test_Contains_ExistingKey;
begin
  FCache.Put('key1', 'value1');
  Assert.IsTrue(FCache.Contains('key1'));
end;

procedure TTestDeepBaseCache.Test_Contains_NonExistent;
begin
  Assert.IsFalse(FCache.Contains('nonexistent'));
end;

procedure TTestDeepBaseCache.Test_Remove_ExistingKey;
begin
  FCache.Put('key1', 'value1');
...
procedure TTestDeepBaseCache.Test_Remove_NonExistent_ReturnsFalse;
begin
  Assert.IsFalse(FCache.Remove('nonexistent'));
end;

procedure TTestDeepBaseCache.Test_Clear_RemovesAllItems;
begin
  FCache.Put('key1', 'value1');
...
procedure TTestDeepBaseCache.Test_Count_Property;
begin
  Assert.AreEqual(0, Integer(FCache.Count));
...
procedure TTestDeepBaseCache.Test_Keys_Property;
var
  Keys: TArray<string>;
begin
...
procedure TTestDeepBaseCache.Test_LFU_EvictsLeastFrequentlyUsed;
var
  I: Integer;
begin
  FCache.MaxItems := 3;
...
procedure TTestDeepBaseCache.Test_TTL_ItemExpiresAfterTimeout;
var
  Value: string;
begin
...
procedure TTestDeepBaseCache.Test_TTL_GetExpiredItem_ReturnsFalse;
var
  Value: string;
begin
  FCache.Put('key1', 'value1', 1); // 1 second TTL
...
procedure TTestDeepBaseCache.Test_SetTTL_UpdatesExpiration;
var
  Value: string;
begin
  FCache.Put('key1', 'value1', 1); // 1 second TTL
...
procedure TTestDeepBaseCache.Test_GetTTL_ReturnsRemainingTime;
var
  TTL: Integer;
begin
...
procedure TTestDeepBaseCache.Test_Cleanup_RemovesExpiredItems;
begin
  FCache.Put('key1', 'value1', 1); // 1 second TTL
...
procedure TTestDeepBaseCache.Test_MaxItems_EvictsWhenFull;
begin
  FCache.MaxItems := 5;
...
procedure TTestDeepBaseCache.Test_Put_UpdateExisting_NoEviction;
begin
  FCache.MaxItems := 3;
...
procedure TTestDeepBaseCache.Test_Stats_HitIncrementsOnGet;
var
  Value: string;
  InitialHits: Int64;
begin
...
procedure TTestDeepBaseCache.Test_Stats_MissIncrementsOnMiss;
var
  Value: string;
  InitialMisses: Int64;
begin
...
procedure TTestDeepBaseCache.Test_Stats_HitRate_Calculation;
var
  Value: string;
begin
  FCache.Put('key1', 'value1');
...
procedure TTestDeepBaseCache.Test_Stats_EvictionCount;
var
...
procedure TTestDeepBaseCache.Test_GetMany_ReturnsMatchingItems;
var
...
procedure TTestDeepBaseCache.Test_PutMany_InsertsMultipleItems;
var
...
procedure TTestDeepBaseCache.Test_RemoveMany_RemovesMultipleItems;
var
  Keys: TArray<string>;
begin
  FCache.Put('key1', 'value1');
...
procedure TTestDeepBaseCache.Test_OnEvict_CalledOnEviction;
var
  EvictedKey: string;
  EvictedValue: string;
  EvictCalled: Boolean;
...
procedure TTestDeepBaseCache.Test_OnLoad_CalledOnGetOrLoad;
var
  LoadCalled: Boolean;
begin
  LoadCalled := False;
...
procedure TTestDeepBaseCache.Test_ThreadSafety_ConcurrentReadWrite;
var
  Tasks: TArray<ITask>;
  I: Integer;
  ErrorCount: Integer;
...
initialization
  TDUnitX.RegisterTestFixture(TTestDeepBaseCache);
