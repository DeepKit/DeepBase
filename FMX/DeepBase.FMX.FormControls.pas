...
type
  ...
  public
    ...
    procedure ReDeepMoveControl(Control: TUniMaterialEdit);
    procedure Clear;
  ...
  private
    ...
    procedure ReDeepMoveChipControl(const Text: string);
  ...
  public
    ...
    procedure ReDeepMoveChip(const Text: string);
...
procedure TUniFormValidator.ReDeepMoveControl(Control: TUniMaterialEdit);
begin
...
begin
  ...
  begin
    ReDeepMoveChip(FChips[FChips.Count - 1]);
  end;
end;
...
begin
  if Sender is TLabel then
    ReDeepMoveChip(TLabel(Sender).TagString);
end;
...
procedure TUniChipInput.ReDeepMoveChipControl(const Text: string);
var
  I: Integer;
begin
...
procedure TUniChipInput.ReDeepMoveChip(const Text: string);
var
  Index: Integer;
begin
