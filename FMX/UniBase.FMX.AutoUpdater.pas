{ ============================================================================
  UniBase.FMX.AutoUpdater - FMX 自动更新组件
  ...
  支持平台:
    ...
    - macOS: 直接下载 DMG/PKG
    - iOS: 跳转 App Store
    - Android: 下载 APK 或跳转 Play Store
  ============================================================================ }

unit UniBase.FMX.AutoUpdater;
...
uses
  ...
  Macapi.Foundation,
  {$ENDIF}
  UniBase.FMX.UpdateDialog;

procedure Register;
begin
  RegisterComponents('UniBase FMX', [TFMXAutoUpdater]);
end;
