{ ============================================================================
  DeepBase.FMX.LicenseStatusPanel - FMX License Status Panel
...
unit DeepBase.FMX.LicenseStatusPanel;
...
begin
  ...
  if Info.IsValid then
    FLblStatus.Text := 'Status: ' + TDeepBaseLicense.LicenseStatusToStr(Info.Status)
  else
    FLblStatus.Text := 'Status: Not Licensed';

  // Type
  FLblType.Text := 'Type: ' + TDeepBaseLicense.LicenseTypeToStr(Info.LicenseType);
...
procedure TFMXLicenseStatusPanel.SetLicense(Value: TDeepBaseLicense);
begin
