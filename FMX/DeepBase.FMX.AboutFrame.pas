...
const
  ...
  TIP_WECHAT = '微信扫码打赏';
  TIP_ALIPAY = 'Scan Alipay QR code to donate';
  TIP_BTC = 'BTC 打赏';
  TIP_USDT = 'USDT (TRC20) 打赏';
  TIP_ABOUTME = 'About developer';
...
begin
  ...
  {$ELSE}
  Info := 'DeepBase_' + DateTimeToStr(Now);
  {$ENDIF}
...
begin
  ...
  begin
    ...
    ShowMessage('BTC address copied to clipboard');
  end;
end;
...
begin
  ...
  begin
    ...
    ShowMessage('USDT address copied to clipboard');
  end;
end;
