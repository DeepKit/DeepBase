...
type
  ...
  TBackendConfig = record
    ...
    class function Loki(const AUrl: string; const AJob: string = 'unibase'): TBackendConfig; static;
...
function CreateLokiBackend(const AUrl: string; const AJob: string = 'unibase'): ILogBackend;
