...
type
  ...
  INotifyCollectionChanged = interface
    ...
    procedure RemoveCollectionChangedHandler(Handler: TCollectionChangedEvent);
  end;
...
procedure TObservableList<T>.RemoveCollectionChangedHandler(Handler: TCollectionChangedEvent);
begin
...
begin
  ...
  if Supports(Source, INotifyPropertyChanged, Observable) then
