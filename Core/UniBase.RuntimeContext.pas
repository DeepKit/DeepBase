{ ============================================================================
  ...
  Runtime lifecycle coordinator for UniBase services.
  This unit intentionally has no UI, database, or manager dependencies.
  ============================================================================ }

unit UniBase.RuntimeContext;
...
type
  ...
  TUniBaseRuntimeComponent = class(TInterfacedObject, IRuntimeComponent)
  private
    FName: string;
  protected
  ...
  TUniBaseRuntimeContext = class(TObject, IRuntimeContext)
  private
...
function RuntimeContext: TUniBaseRuntimeContext;
procedure SetRuntimeContext(AContext: TUniBaseRuntimeContext);

implementation

var
  GRuntimeContext: TUniBaseRuntimeContext;

{ TUniBaseRuntimeComponent }

constructor TUniBaseRuntimeComponent.Create(const AName: string);
begin
  inherited Create;
  FName := AName;
end;

function TUniBaseRuntimeComponent.GetName: string;
begin
  Result := FName;
end;

procedure TUniBaseRuntimeComponent.Configure;
begin
end;

procedure TUniBaseRuntimeComponent.Initialize;
begin
end;

procedure TUniBaseRuntimeComponent.Start;
begin
end;

procedure TUniBaseRuntimeComponent.Stop;
begin
end;

procedure TUniBaseRuntimeComponent.Shutdown;
begin
end;

{ TUniBaseRuntimeContext }

constructor TUniBaseRuntimeContext.Create;
begin
  inherited Create;
...
destructor TUniBaseRuntimeContext.Destroy;
begin
...
function TUniBaseRuntimeContext.GetComponentCount: Integer;
begin
  Result := FComponents.Count;
end;

function TUniBaseRuntimeContext.GetConfigured: Boolean;
begin
  Result := FConfigured;
end;

function TUniBaseRuntimeContext.GetInitialized: Boolean;
begin
  Result := FInitialized;
end;

function TUniBaseRuntimeContext.GetStarted: Boolean;
begin
  Result := FStarted;
end;

function TUniBaseRuntimeContext.GetShutdownComplete: Boolean;
begin
  Result := FShutdown;
end;

function TUniBaseRuntimeContext._AddRef: Integer;
begin
  Result := -1;
end;

function TUniBaseRuntimeContext._Release: Integer;
begin
  Result := -1;
end;

function TUniBaseRuntimeContext.QueryInterface(const IID: TGUID;
  out Obj): HResult;
begin
...
procedure TUniBaseRuntimeContext.EnsureMutable;
begin
...
procedure TUniBaseRuntimeContext.RegisterComponent(
...
function TUniBaseRuntimeContext.ComponentName(Index: Integer): string;
begin
...
procedure TUniBaseRuntimeContext.Configure;
var
...
procedure TUniBaseRuntimeContext.Initialize;
var
  Component: IRuntimeComponent;
begin
...
procedure TUniBaseRuntimeContext.Start;
var
  Component: IRuntimeComponent;
begin
  if FStarted then
...
procedure TUniBaseRuntimeContext.Stop;
begin
  StopStartedComponents(True);
end;

procedure TUniBaseRuntimeContext.Shutdown;
begin
  StopStartedComponents(True);
...
procedure TUniBaseRuntimeContext.StopStartedComponents(
...
procedure TUniBaseRuntimeContext.ShutdownConfiguredComponents(
  PropagateErrors: Boolean);
var
  I: Integer;
  Component: IRuntimeComponent;
...
begin
  if GRuntimeContext = nil then
    GRuntimeContext := TUniBaseRuntimeContext.Create;
