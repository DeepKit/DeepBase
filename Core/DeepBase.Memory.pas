...
uses
  ...
  System.TypInfo, System.Rtti, DeepBase.Logging, DeepBase.ObjectPool,
  DeepBase.Cache;
...
type
  ...
  private
    ...
    FInner: DeepBase.ObjectPool.TObjectPool<T>;
    FMinSize: Integer;
    FMaxSize: Integer;
    FGrowBy: Integer;

    function CreateCanonicalConfig: DeepBase.ObjectPool.TPoolConfig;
...
begin
  // DeepBase.Memory keeps its legacy reset semantics on Release.
end;
...
begin
  ...
  FInner := DeepBase.ObjectPool.TObjectPool<T>.Create(FFactoryAdapter,
...
function TObjectPool<T>.CreateCanonicalConfig: DeepBase.ObjectPool.TPoolConfig;
begin
  Result := DeepBase.ObjectPool.TPoolConfig.Default;
...
var
  Config: DeepBase.ObjectPool.TPoolConfig;
begin
  FMinSize := Value;
...
begin
  ...
  try
    ...
    begin
      IsValid := False;
      LLogger := DeepBase.Logging.Logger;
...
var
  Stats: DeepBase.ObjectPool.TPoolStats;
begin
...
var
  Current: DeepBase.Cache.TCacheStats;
begin
