{ ============================================================================
  UniBase.Services.Protection - Protection Service Implementations
...
unit UniBase.Services.Protection;
...
begin
  ...
  if FStorage = nil then
    raise EInvalidOperation.Create(
      ...
      'Include UniBase.Persistence.Protection.FireDAC or UniBasePersistence package.');
...
begin
  Result.KeyString := '';
  Result.IntegrityKey := 'UniBase_Integrity_Key';
  Result.DatabasePath := '';
