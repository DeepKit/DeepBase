{ ============================================================================
  UniBase.SingleInstance - Single Instance Application Support
...
const
  ...
  /// </summary>
  WM_UNIBASE_COPYDATA = WM_USER + $1B01;
  WM_UNIBASE_ACTIVATE = WM_USER + $1B02;
...
const
  MESSAGE_WINDOW_CLASS = 'UniBase_SingleInstance_MessageWindow';
...
begin
  ...
  FMutexName := 'Global\UniBase_' + AppIdentifier;
...
begin
  ...
  begin
    ...
    PostMessage(TargetWnd, WM_UNIBASE_ACTIVATE, 0, 0);
...
begin
  ...
  CopyData.dwData := WM_UNIBASE_COPYDATA;
  ...
  case Msg of
    WM_COPYDATA:
      begin
        ...
        if (CopyData <> nil) and (CopyData^.dwData = WM_UNIBASE_COPYDATA) then
        begin
