...
begin
  ...
  begin
    ...
    Consume(ttOperator);
    Result := TBinaryOpNode.Create(Op, Result, ParseAnd);
  end;
end;
...
begin
  ...
  begin
    Op := FCurrentToken.Value;
    Consume(ttOperator);
    Result := TBinaryOpNode.Create(Op, Result, ParseEquality);
  end;
end;
...
begin
  ...
  begin
    Op := FCurrentToken.Value;
    Consume(ttOperator);
    Result := TBinaryOpNode.Create(Op, Result, ParseComparison);
  end;
end;
...
begin
  ...
  begin
    Op := FCurrentToken.Value;
    Consume(ttOperator);
    Result := TBinaryOpNode.Create(Op, Result, ParseAdditive);
  end;
end;
...
begin
  ...
  begin
    Op := FCurrentToken.Value;
    Consume(ttOperator);
    Result := TBinaryOpNode.Create(Op, Result, ParseMultiplicative);
  end;
end;
...
begin
  ...
  begin
    Op := FCurrentToken.Value;
    Consume(ttOperator);
    Result := TBinaryOpNode.Create(Op, Result, ParsePower);
  end;
end;
...
begin
  ...
  begin
    Consume(ttOperator);
    Result := TBinaryOpNode.Create('^', Result, ParsePower); // Right associative
  end;
end;
...
begin
  ...
  begin
    Op := FCurrentToken.Value;
    Consume(ttOperator);
    Result := TUnaryOpNode.Create(Op, ParseUnary);
  end
  else
    Result := ParsePrimary;
end;
...
begin
  case FCurrentToken.TokenType of
    ttNumber:
    begin
      Result := TNumberNode.Create(FCurrentToken.NumValue);
      Consume(ttNumber);
    end;
    
    ttString:
    begin
      Result := TStringNode.Create(FCurrentToken.Value);
      Consume(ttString);
    end;
