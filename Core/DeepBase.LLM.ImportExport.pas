{ ============================================================================
  DeepBase.LLM.ImportExport - Prompt Import/Export Module
...
unit DeepBase.LLM.ImportExport;
  ...
  try
    ...
    try
      ...
      case Format of
        ...
        efYAML:
          Content := '# DeepBase LLM Prompts Export' + sLineBreak + 
...
begin
  ...
  try
    ...
    case Format of
      ...
      efYAML:
        Result := '# DeepBase LLM Prompts Export' + sLineBreak + 
                  '# Version: ' + EXPORT_VERSION + sLineBreak + 
                  sLineBreak + JsonToYaml(RootObj);
    end;
  finally
