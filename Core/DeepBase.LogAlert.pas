unit DeepBase.LogAlert;

{*******************************************************************************
  DeepBase Log Alert System
  ...
  - Alert hiDeepStory and deduplication
...
type
  ...
  /// <summary>Alert hiDeepStory entry</summary>
  ...
  public
    ...
    /// <summary>Get alert hiDeepStory</summary>
    function GetHistory(ALimit: Integer = 100): TArray<TAlertHistoryEntry>;
    /// <summary>Clear hiDeepStory</summary>
