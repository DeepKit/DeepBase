{ ============================================================================
  UniBase.Services.Interfaces - Service Interfaces for Dependency Injection
  ...
  Usage:
    ...
    UniBase.Services.Registration.RegisterDefaultServices(GlobalContainer);
...
unit UniBase.Services.Interfaces;
