{ ============================================================================
  UniBase.SplashScreen - Splash Screen Support
...
unit UniBase.SplashScreen;

{$IFDEF FMX}
  {$MESSAGE FATAL 'UniBase.SplashScreen is VCL-only. For FMX, implement your own splash screen using FMX.Forms.'}
{$ENDIF}
