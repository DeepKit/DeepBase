...
begin
  ...
  begin
    ...
    if Length(FImages[I].Data) > 0 then
      AStream.WriteBuffer(FImages[I].Data[0], Length(FImages[I].Data));
  ...
  begin
    ...
    if Length(ContentBytes) > 0 then
      AStream.WriteBuffer(ContentBytes[0], Length(ContentBytes));
    WriteBuf(#10'endstream'#10'endobj'#10);
  end;
