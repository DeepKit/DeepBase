...
type
  ...
  TUniBaseThemeManager = class
  private
    class var FInstance: TUniBaseThemeManager;
...
{ TUniBaseThemeManager }

class constructor TUniBaseThemeManager.Create;
begin
  FThemes := TDictionary<string, TThemeDefinition>.Create;
  FCurrentTheme := '';
end;

class destructor TUniBaseThemeManager.Destroy;
begin
  FThemes.Free;
end;

class procedure TUniBaseThemeManager.RegisterTheme(const ATheme: TThemeDefinition);
begin
  FThemes.AddOrSetValue(ATheme.Name, ATheme);
end;

class procedure TUniBaseThemeManager.UnregisterTheme(const AName: string);
begin
...
class function TUniBaseThemeManager.ThemeExists(const AName: string): Boolean;
begin
  Result := FThemes.ContainsKey(AName);
end;

class procedure TUniBaseThemeManager.ApplyColorsToForm(AForm: TForm; const AColors: TThemeColors);
begin
  AForm.Color := AColors.Background;
  AForm.Font.Color := AColors.OnBackground;
end;

class procedure TUniBaseThemeManager.ApplyTypographyToForm(AForm: TForm; 
...
class procedure TUniBaseThemeManager.ApplyTheme(const AName: string);
var
...
class procedure TUniBaseThemeManager.ApplyTheme(const AName: string; AForm: TForm);
var
  Theme: TThemeDefinition;
begin
  Theme := GetTheme(AName);
...
class function TUniBaseThemeManager.GetCurrentColors: TThemeColors;
begin
...
class function TUniBaseThemeManager.GetCurrentTypography: TThemeTypography;
begin
  if FCurrentTheme <> '' then
...
class function TUniBaseThemeManager.GetCurrentSpacing: TThemeSpacing;
begin
  if FCurrentTheme <> '' then
...
class function TUniBaseThemeManager.IsDarkTheme: Boolean;
var
  Theme: TThemeDefinition;
begin
  Result := False;
...
class procedure TUniBaseThemeManager.ToggleDarkMode;
var
  Theme: TThemeDefinition;
  NewThemeName: string;
begin
...
begin
  // Material themes
  TUniBaseThemeManager.RegisterTheme(TMaterialThemes.Light);
  TUniBaseThemeManager.RegisterTheme(TMaterialThemes.Dark);
  TUniBaseThemeManager.RegisterTheme(TMaterialThemes.BlueLight);
  TUniBaseThemeManager.RegisterTheme(TMaterialThemes.BlueDark);
  TUniBaseThemeManager.RegisterTheme(TMaterialThemes.IndigoLight);
  TUniBaseThemeManager.RegisterTheme(TMaterialThemes.IndigoDark);
  TUniBaseThemeManager.RegisterTheme(TMaterialThemes.TealLight);
  TUniBaseThemeManager.RegisterTheme(TMaterialThemes.TealDark);
  TUniBaseThemeManager.RegisterTheme(TMaterialThemes.DeepOrangeLight);
  TUniBaseThemeManager.RegisterTheme(TMaterialThemes.DeepOrangeDark);
  
  // Fluent themes
  TUniBaseThemeManager.RegisterTheme(TFluentThemes.Light);
  TUniBaseThemeManager.RegisterTheme(TFluentThemes.Dark);
  TUniBaseThemeManager.RegisterTheme(TFluentThemes.AcrylicLight);
  TUniBaseThemeManager.RegisterTheme(TFluentThemes.AcrylicDark);
  
  // macOS themes
  TUniBaseThemeManager.RegisterTheme(TMacOSThemes.Light);
  TUniBaseThemeManager.RegisterTheme(TMacOSThemes.Dark);
  TUniBaseThemeManager.RegisterTheme(TMacOSThemes.BigSurLight);
  TUniBaseThemeManager.RegisterTheme(TMacOSThemes.BigSurDark);
end;
