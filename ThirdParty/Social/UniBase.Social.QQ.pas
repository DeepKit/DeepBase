unit UniBase.Social.QQ;

{*******************************************************************************
  UniBase QQ Social Integration
...
begin
  ...
  FCredentialTarget := 'UniBase.Social.QQ';
end;
...
begin
  ...
  // Prefer POST body to avoid exposing client_secret in URL logs/history.
