...
- **LLM Adapter** - Integration with UniBase.LLM (OpenAI/Claude/Azure/Ollama)
...
- Chinese docs: 快速入门, 工作流格式, Skill开发, 部署指南
- API Reference
...
### API Changes
- Use `UniBase.LLM` instead of `UniFlow.AI.LLMClient`
- Error codes follow `{Source}/{Category}/{Specific}` format

---

**UniFlow Version**: 1.0.0
**Minimum UniBase Version**: 1.0.0
