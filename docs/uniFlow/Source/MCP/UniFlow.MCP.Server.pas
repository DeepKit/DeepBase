...
(*
  ...
  实现 MCP Server 端，将 UniFlow 能力暴露给外部 LLM/Agent
  
  功能:
  - JSON-RPC 2.0 消息处理
  - Tool/Resource/Prompt 注册与发现
  - 请求路由与响应
  - 会话管理
*)
...
type
  ...
  TMCPServerConfig = record
    ...
    MaxRequestSize: Integer;       // 最大请求大小 (字节)
  ...
  public
    ...
    /// <summary>处理 JSON-RPC 请求 (字符串)</summary>
