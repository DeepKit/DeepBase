...
type
  ...
  TDebuggerConfig = record
    Enabled: Boolean;
    BreakOnStart: Boolean;      // 启动时暂停
    BreakOnError: Boolean;      // 错误时暂停
    BreakOnEnd: Boolean;        // 结束时暂停
