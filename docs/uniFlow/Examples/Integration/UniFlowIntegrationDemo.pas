...
(*
  ...
  演示如何在 UniBase 应用中集成 UniFlow 工作流引擎。
  
  运行方式:
    1. 确保 Python Skill 服务已启动 (cd Skills && python -m uvicorn main:app)
    2. 编译并运行此程序
...
begin
  ...
  Engine.RegisterIntent('calculate',
    ['calculate', 'compute', '计算', '算一下'],
    ['calculate', 'compute', 'sum', 'add', '计算', '加', '减', '乘', '除'],
    20);
