unit UniFlow.Commander;

{*******************************************************************************
  UniFlow.Commander - 指挥官角色 (L4 决策层)
...
type
  ...
  TCommander = class(TUniFlowRoleBase, ICommander)
  private
...
function TCommander.DoHandleMessage(const AMessage: TUniFlowMessage): TUniFlowMessage;
var
  Input: string;
  SessionId: string;
