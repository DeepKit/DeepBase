...
type
  ...
  EUniBaseCommerceError = class(Exception);
  EUniBaseCommerceValidationError = class(EUniBaseCommerceError);
  EUniBaseCommerceNotFoundError = class(EUniBaseCommerceError);
  EUniBaseCommercePaymentError = class(EUniBaseCommerceError);
