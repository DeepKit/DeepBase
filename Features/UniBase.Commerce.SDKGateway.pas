unit UniBase.Commerce.SDKGateway;

{==============================================================================
  UniBase.Commerce.SDKGateway - Bridge Payment SDK to Commerce Gateway

  Bridges the ThirdParty Payment SDK (UniBase.Payment) to the Commerce
...
type
  /// <summary>
  /// Adapter that wraps an IPaymentClient from UniBase.Payment into
  /// the ICommercePaymentGateway interface used by TUniBaseCommerceService.
  /// </summary>
