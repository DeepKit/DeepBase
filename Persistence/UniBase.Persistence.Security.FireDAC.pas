{ ============================================================================
  UniBase.Persistence.Security.FireDAC - FireDAC adapter for security secrets
  ============================================================================
  Moves Secrets SQL/FireDAC persistence out of Core\UniBase.Security.
  ============================================================================
}

unit UniBase.Persistence.Security.FireDAC;
...
procedure RegisterSecurityStorageFactory;
begin
  TUniBaseSecurity.SetStorageFactory(
