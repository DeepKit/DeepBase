{ ============================================================================
  DeepBase.DB.ConnectionPool - Database Connection Pool
  
  Version: 1.0
  Package: DeepBasePersistence
...
unit DeepBase.DB.ConnectionPool;
...
type
  ...
  end deprecated 'Use TUniConnectionPool from DeepBase.DB.Pool with DatabaseType := dbSQLite';
