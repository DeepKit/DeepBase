{ ============================================================================
  UniBase.Persistence.Hotkeys.FireDAC - FireDAC adapter for hotkeys storage
  ============================================================================
  Registers FireDAC implementation for IHotkeyStorage.
  ============================================================================ }

unit UniBase.Persistence.Hotkeys.FireDAC;
...
procedure RegisterHotkeysFireDACStorageFactory;
begin
  TUniBaseHotkeys.SetConnectionStorageFactory(
