{ ============================================================================
  UniBase.Persistence.License.FireDAC - FireDAC adapter for license storage
  ============================================================================
  Moves LicenseInfo SQL/FireDAC persistence out of Core\UniBase.License.
  ============================================================================ }

unit UniBase.Persistence.License.FireDAC;
...
procedure RegisterLicenseStorageFactory;
begin
  TUniBaseLicense.SetStorageFactory(
