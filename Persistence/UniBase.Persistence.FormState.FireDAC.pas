{ ============================================================================
  UniBase.Persistence.FormState.FireDAC - FireDAC adapter for form state
  ============================================================================
  Moves SQL/FireDAC details out of Core. Core keeps only repository contracts.
  ============================================================================ }

unit UniBase.Persistence.FormState.FireDAC;
...
procedure RegisterFormStateStorageFactory;
begin
  TUniBaseFormState.SetConnectionStorageFactory(
