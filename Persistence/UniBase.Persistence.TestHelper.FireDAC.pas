{ ============================================================================
  UniBase.Persistence.TestHelper.FireDAC
  ============================================================================
  FireDAC snapshot storage adapter for UniBase.TestHelper.
  ============================================================================ }

unit UniBase.Persistence.TestHelper.FireDAC;
...
procedure RegisterTestSnapshotStorageFactory;
begin
  TUniBaseTestHelper.SetSnapshotStorageFactory(
