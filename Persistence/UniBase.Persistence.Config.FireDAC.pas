{ ============================================================================
  UniBase.Persistence.Config.FireDAC - FireDAC adapter for config storage
  ============================================================================
  Registers FireDAC implementation for IConfigStorage.
  ============================================================================ }

unit UniBase.Persistence.Config.FireDAC;
...
procedure RegisterConfigStorageFactory;
begin
  TUniBaseConfig.SetConnectionStorageFactory(
